      ...
      <div className='flex justify-center items-center space-x-20 mt-30'>
        ...
        <div>
          ...
          <div className="mt-10 justify-content">
              ...
              >
                <svg className="mr-1 w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
